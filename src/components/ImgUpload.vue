    ...
    <div>
        <div class="evaluateImgCon" v-show="!showClip">
            ...
            <div class="evaluateUploadImg" @click="openUploadPop($event)" v-if="imagePreviewList.length < max">
                ...
                <input v-if="isWx && !isClip" type="file" class="uploadFile" accept="image/*" capture="camera" ref="upload" @change="uploadImg" multiple="">
                <input v-if="!isWx && !isClip" type="file" class="uploadFile" accept="image/*" ref="upload" @change="uploadImg" multiple="">
                <input v-if="isWx && isClip" type="file" class="uploadFile" accept="image/*" capture="camera" ref="upload" @change="uploadImg">
                <input v-if="!isWx && isClip" type="file" class="uploadFile" accept="image/*" ref="upload" @change="uploadImg">
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.isClip) {
                loadJSFile('//static.djtest.cn/fe/other/lx20170226/clip/js/touch.min.js', () => {
